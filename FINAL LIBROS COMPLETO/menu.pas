...
interface
  ...
  uses
    Archivos, Arbol, Tipos, Libro, Persona, Utiles, UnicodeCRT { Unidad de CRT Que soporta Unicode };
...
//                espacio := opciones.longitudMax DIV long;
  ...
  begin
    ...
    repeat
      ...
      gotoxy(WindMaxX DIV 4, 1);
      writeln('┌────────────────────────────────────────────────┐');
      // gotoxy(WindMaxX DIV 4, 2);
      // writeln('│                                                │');
      gotoxy(WindMaxX DIV 4, 2);
      write  ('│                 '); TextColor(118); Write('Menú Principal'); TextColor(111);Writeln('                 │');
      // gotoxy(WindMaxX DIV 4, 4);
      // writeln('│                                                │');
      gotoxy(WindMaxX DIV 4, 3);
      writeln('└────────────────────────────────────────────────┘');
      writeln;
      ...
      1:  begin
            ...
            repeat
              ...
              { 
                ┌────────────────────────────────────────────────────┐
                │          ALTA BAJA MODIFICACION DE LIBROS          │
                └────────────────────────────────────────────────────┘
              }   
              gotoxy(WindMaxX DIV 4, 1);
              writeln('┌────────────────────────────────────────────────────┐');
              ...
              // writeln('│                                                │');
              gotoxy(WindMaxX DIV 4, 2);
              write  ('│          '); TextColor(118); Write('Alta/Baja/Modificación de Libros'); TextColor(111);Writeln('          │');
              // gotoxy(WindMaxX DIV 4, 4);
              // writeln('│                                                │');
              gotoxy(WindMaxX DIV 4, 3);
              writeln('└────────────────────────────────────────────────────┘');
      ...
      7: begin   
            ...
            // writeln('│                                                │');
            gotoxy(WindMaxX DIV 4, 2);
            write  ('│                  '); TextColor(118); Write('Estadísticas'); TextColor(111);Writeln('                  │');
            // gotoxy(WindMaxX DIV 4, 4);
            // writeln('│                                                │');
            gotoxy(WindMaxX DIV 4, 3);
            writeln('└────────────────────────────────────────────────┘');
