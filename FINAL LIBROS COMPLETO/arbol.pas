...
interface
  ...
  // Arbol
    ...
    function BuscarEnArbol(raiz: t_punt_arbol; buscado: QWord): t_punt_arbol;
  ...
  // Listado
    ...
    function Preorden(raiz: t_punt_arbol; buscado: QWord): t_punt_arbol;
...
implementation
  ...
  begin
    ...
    else if (raiz^.info.id > x.id) then
  ...
  begin
    ...
    if (raiz^.info.id = buscado) then
      Preorden := raiz
    else if (raiz^.info.id > buscado) then
